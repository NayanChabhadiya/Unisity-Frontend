...
import logoImage from "assets/unisity.png";
import bannerImage from "assets/banner-mockup.png";
import DashOne from "assets/dashOne.png";
...
import { Slogan } from "analytics/slogan";
    ...
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Image
          ...
          style={{ height: "120px" }}
        />
        <Heading as="h2">{Slogan[num]?.title} </Heading>
        <img
